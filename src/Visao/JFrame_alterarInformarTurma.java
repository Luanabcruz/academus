 ...
 * @author Anderson
 */
public class JFrame_alterarInformarTurma extends javax.swing.JFrame {
     ...
     */
    public JFrame_alterarInformarTurma() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alterar dados do informar turmar");
    ...
    private void jB_buscarAlteraInformarTurmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_buscarAlteraInformarTurmaActionPerformed
         if(!(jT_buscarAlterarInformarTurma.getText().equals(""))){
             ...
             try {
                 ...
                 Logger.getLogger(JFrame_alterarInformarTurma.class.getName()).log(Level.SEVERE, null, ex);
             }
             if(model!=null){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_alterarInformarTurma().setVisible(true);
            }
        });
    }
